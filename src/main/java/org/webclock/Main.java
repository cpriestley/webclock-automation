...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Map<String, String> creds = CredentialsLoader.loadCredentials();
        ...
        try {
            ...
            driver.get("https://www.itcs-webclock.com/prod/4ESC01/home.cfm");
            ...
            // Click the OK button
            driver.findElement(By.cssSelector("#tcHourEntry > div > div > div > div > div:nth-child(4) > div > input")).click();
    ...
    public static int getTotalHours(WebDriver driver) {
